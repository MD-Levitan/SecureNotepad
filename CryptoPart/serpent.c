...
static void serpent_whiten(serpent_blk *dst, serpent_key*src, int idx) {
    uint8_t i;
...
void serpent_set_encrypt_key(serpent_key*key, const unsigned char *user_key)
{
    union {
        uint8_t b[32];
        uint32_t w[8];
...
void serpent_set_decrypt_key(serpent_key*key, const unsigned char *user_key)
{
    union {
        uint8_t b[32];
        uint32_t w[8];
...
void serpent_encrypt_block(void *in, serpent_key*key)
{
    int8_t i;
    serpent_blk *_out = in;
...
void serpent_decrypt_block(void *in, serpent_key*key)
{
    int8_t i;
    serpent_blk *_out = in;
